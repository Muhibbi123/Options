...
public class MainActivity extends AppCompatActivity {
    ...
    @Override //On program execution, you need to push the button for a while. After that the choices will appear.
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item){
        switch(item.getItemId()){
            case R.id.item1:
                Toast.makeText(MainActivity.this, item.getTitle().toString() + " 1", Toast.LENGTH_LONG).show();
                break;
